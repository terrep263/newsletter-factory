      ...
      <div className="grid">
        {brands.map((b) => (
          <div className="card" key={b.id}>
            ...
            <p>{Array.isArray(b.coverage) && b.coverage.length ? `Coverage: ${b.coverage.join(", ")}` : "No coverage set"}</p>
            <p className="meta">{b.letterman_publication_id ? `Letterman pub: ${b.letterman_publication_id}` : "Not linked to a Letterman publication yet"}</p>
          </div>
        ))}
      </div>
    </main>
